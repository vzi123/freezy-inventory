...
public class CategoryUOMMapController_old {
    @Autowired
    ...
    @GetMapping("/{id}")
    public CategoryUOMMap_old getCategoryUOMMapById(@PathVariable String id) {
        return categoryUOMMapService.getCategoryUOMMapById(id);
    }

    @PostMapping
    public void addCategoryUOMMap(@RequestBody CategoryUOMMap_old categoryUOMMap) {
        categoryUOMMapService.saveCategoryUOMMap(categoryUOMMap);
    }

    @PutMapping("/{id}")
    public void updateCategoryUOMMap(@PathVariable String id, @RequestBody CategoryUOMMap_old categoryUOMMap) {
